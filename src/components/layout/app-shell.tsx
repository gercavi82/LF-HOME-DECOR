...
const navigation: NavigationItem[] = [
  ...
  { label: "Comisiones", href: "/reportes", icon: CircleDollarSign, permissions: ["COMISIONES_VER", "REPORTES_VER", "VENTA_VER"] },
  ...
  { label: "Alertas", href: "/alertas", icon: Bell, permissions: ["INVENTARIO_AJUSTAR", "COMPRA_VER", "DASHBOARD_VER"] },
