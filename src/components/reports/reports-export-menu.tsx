...
export function ReportsExportMenu({ currentParams }: ReportsExportMenuProps) {
  ...
  const buildExportUrl = (formato: "xlsx" | "pdf" | "csv") => {
    ...
    return `/api/exportar/reportes?${params.toString()}`;
  };
  ...
  return (
    <div className="relative inline-block text-left" ref={menuRef}>
      <button
        ...
        title="Exportar reporte financiero y comisiones"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 z-50 mt-2 w-60 origin-top-right rounded-2xl border border-slate-100 bg-white p-2 shadow-xl ring-1 ring-black/5 animate-in fade-in zoom-in-95 duration-100">
          <div className="px-3 py-2 text-[11px] font-semibold uppercase tracking-wider text-slate-400">
            Formatos de reporte financiero
          </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Libro multipestaña completo</p>
            </div>
          </a>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Membretado y Liquidaciones</p>
            </div>
          </a>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Datos tabulares comisiones</p>
            </div>
          </a>
        </div>
      )}
