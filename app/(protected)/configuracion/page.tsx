  ...
  return (
    <ContentContainer>
      <PageHeader
        ...
        title="Configuración"
        description="Gestiona los catálogos utilizados por productos e inventario."
      />
              ...
              <Card className="h-full transition hover:-translate-y-0.5 hover:shadow-[var(--lf-shadow-md)]">
                <CardContent className="pt-5 sm:pt-5">
                  ...
                  <div className="mt-4 flex items-center justify-between gap-3">
                    <div>
                      <h2 className="font-semibold">{catalog.label}</h2>
                      <p className="mt-1 text-sm text-lf-muted">Administrar registros</p>
                    </div>
                    <ArrowRight
                      size={18}
