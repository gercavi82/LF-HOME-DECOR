...
SELECT id_variante, id_bodega, 'AJUSTE_SALIDA', 5, cantidad, 51, NOW(), 'Ajuste por conteo físico en tienda (Excel cuadre)', 'AJUSTE_FISICO', 1
...
INSERT INTO movimientos_inventario (id_variante, id_bodega, tipo, cantidad, stock_anterior, stock_nuevo, fecha, motivo, referencia_tipo, usuario)
SELECT id_variante, id_bodega, 'AJUSTE_SALIDA', 1, cantidad, 0, NOW(), 'Ajuste por conteo físico en tienda (Excel cuadre)', 'AJUSTE_FISICO', 1
...
INSERT INTO movimientos_inventario (id_variante, id_bodega, tipo, cantidad, stock_anterior, stock_nuevo, fecha, motivo, referencia_tipo, usuario)
SELECT id_variante, id_bodega, 'AJUSTE_SALIDA', 2, cantidad, 23, NOW(), 'Ajuste por conteo físico en tienda (Excel cuadre)', 'AJUSTE_FISICO', 1
...
INSERT INTO movimientos_inventario (id_variante, id_bodega, tipo, cantidad, stock_anterior, stock_nuevo, fecha, motivo, referencia_tipo, usuario)
SELECT id_variante, id_bodega, 'AJUSTE_SALIDA', 46, cantidad, 40, NOW(), 'Ajuste por conteo físico en tienda (Excel cuadre)', 'AJUSTE_FISICO', 1
...
INSERT INTO movimientos_inventario (id_variante, id_bodega, tipo, cantidad, stock_anterior, stock_nuevo, fecha, motivo, referencia_tipo, usuario)
SELECT id_variante, id_bodega, 'AJUSTE_SALIDA', 15, cantidad, 0, NOW(), 'Corrección de saldo histórico a físico real 0', 'AJUSTE_FISICO', 1
...
INSERT INTO movimientos_inventario (id_variante, id_bodega, tipo, cantidad, stock_anterior, stock_nuevo, fecha, motivo, referencia_tipo, usuario)
SELECT id_variante, id_bodega, 'AJUSTE_SALIDA', 1, cantidad, 10, NOW(), 'Ajuste por conteo físico en tienda (Excel cuadre)', 'AJUSTE_FISICO', 1
...
INSERT INTO movimientos_inventario (id_variante, id_bodega, tipo, cantidad, stock_anterior, stock_nuevo, fecha, motivo, referencia_tipo, usuario)
SELECT id_variante, id_bodega, 'AJUSTE_SALIDA', 1, cantidad, 49, NOW(), 'Ajuste por conteo físico en tienda (Excel cuadre)', 'AJUSTE_FISICO', 1
...
INSERT INTO movimientos_inventario (id_variante, id_bodega, tipo, cantidad, stock_anterior, stock_nuevo, fecha, motivo, referencia_tipo, usuario)
SELECT id_variante, id_bodega, 'AJUSTE_SALIDA', 2, cantidad, 196, NOW(), 'Ajuste por conteo físico en tienda (Excel cuadre)', 'AJUSTE_FISICO', 1
...
INSERT INTO movimientos_inventario (id_variante, id_bodega, tipo, cantidad, stock_anterior, stock_nuevo, fecha, motivo, referencia_tipo, usuario)
SELECT id_variante, id_bodega, 'AJUSTE_SALIDA', 4, cantidad, 4, NOW(), 'Ajuste por conteo físico en tienda (Excel cuadre)', 'AJUSTE_FISICO', 1
